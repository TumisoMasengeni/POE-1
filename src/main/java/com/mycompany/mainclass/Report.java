...
class Report {
    ...
    public void setTaskData(String[] taskNames, String[] developers, String[] taskStatus, int[] taskDuration, String[] tasKid) {
    ...
    public String displayAllTasksReport() {
    ...
    if (!tasksExist) {
        return "No tasks available to display.";
    }
